...
call cmd /c %PATH_BUILDER%\bin\MoveAssets %PATH_BUILDER%
...
call cmd /c %PATH_BUILDER%\bin\JavaBuild %PATH_BUILDER%
...
call cmd /c %PATH_BUILDER%\bin\GeraPacote %PATH_BUILDER%

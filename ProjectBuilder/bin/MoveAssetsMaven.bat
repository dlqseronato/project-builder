...
:WHILE
	...
	xcopy /E/H/C/I/Y/F %UI_CAMINHO%%UI_DASHBOARD%\assets\i18n\* %JV_CAMINHO%%MAVEN_WEB%\assets\i18n >> %PATH_BUILDER%\tmp\%PROCESSO%.tmp 2>&1
	xcopy /y/f/c %UI_CAMINHO%%UI_DASHBOARD%\assets\* %JV_CAMINHO%%MAVEN_WEB%\assets >> %PATH_BUILDER%\tmp\%PROCESSO%.tmp 2>&1
	xcopy /y/f/c %UI_CAMINHO%%UI_DASHBOARD%\* %JV_CAMINHO%%MAVEN_WEB% >> %PATH_BUILDER%\tmp\%PROCESSO%.tmp 2>&1
